...
from multidim_screening_plain.insurance_d2_m1_deduc import S_fun, b_fun
from multidim_screening_plain.insurance_d2_m1_deduc_values import val_BC, val_D, val_I


def test_dvalBC(build_model):
    model = build_model("insurance_d2_m1_deduc")
    y = np.array([1.6])
