...
from multidim_screening_plain.insurance_d1_m1_risk_deduc_mix import S_fun, b_fun
from multidim_screening_plain.insurance_d1_m1_risk_deduc_mix_values import (
    val_BC,
    val_D,
    val_I,
)
...
def test_dvalBC(build_model):
    model = build_model("insurance_d1_m1_risk_deduc_mix")
    y = np.array([1.6])
    theta = np.array([6.0])
