...
from multidim_screening_plain.insurance_d2_m1_copay import S_fun, b_fun
from multidim_screening_plain.insurance_d2_m1_copay_values import val_BC, val_D, val_I


def test_dvalBC(build_model):
    model = build_model("insurance_d2_m1_copay")
    y = np.array([0.6])
