...
def plot_best_contracts(
    ...
    **kwargs: dict | None,
    ...
    the size and color of a point indicate the deductible
    ...
    ch = (
        ...
        .encode(
            ...
            size=alt.Size("Deductible:Q", scale=alt.Scale(range=[500, 10])),
            tooltip=["Risk-aversion", "Risk location", "Deductible"],
...
def plot_second_best_contracts(
    ...
    **kwargs: dict | None,
    ...
    y_mat = df_second[["Deductible"]].values
    scatter = ax.scatter(
